  ...
  return (
    <div id='services' className='w-full bg-white'>
      ...
      >
        ...
        {/* les services de la construction via le fichier export.js */}
        <motion.div
          initial="hidden"
          variants={zoomInVariants}
          whileInView="visible"
          className='w-full grid lg:grid-cols-3 grid-cols-1 justify-between
        ...
        >
          {
            allservices.map((item, index) => (
              ...
              >
                ...
                hover:bg-yellow-500 rounded-lg p-2'/>
                <div className='flex flex-col justify-center items-start gap-3'>
                  <h1 className='text-[18px] font-bold text-black'>{item.title}</h1>
