  ...
  return (
    <div id='working' className='w-full bg-white'>
          ...
          >
            ...
            {/* les planning de la construction via le fichier export.js */}
            <motion.div
              initial="hidden"
              variants={zoomInVariants}
              whileInView="visible"
              className='w-full grid lg:grid-cols-4 grid-cols-1 justify-between
            ...
            >
              {/* Liste des planning */}
              {
                planning.map((item, index) => (
                  <div key={index}
                    className='flex flex-col justify-center items-center gap-5 border-2 border-yellow-500
                    rounded-mg p-6'
                  >
                    <div>
